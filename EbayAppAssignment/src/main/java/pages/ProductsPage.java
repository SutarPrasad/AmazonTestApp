...
public class ProductsPage extends BaseClass {
	...
	public void selectionRandomProduct(BaseReport reportStatus)  {
		waitForElementClickable(suggestedProductList,reportStatus);
	...
	public String fetchingProductDetails(BaseReport reportStatus)  {
		waitForElementClickable(productSpecification,reportStatus);
	...
	public void addToCart(BaseReport reportStatus)  {
		swipeUp(reportStatus);
		waitForElementClickable(addToCart,reportStatus);
	...
	public void clickOnCartLogo(BaseReport reportStatus) {
		waitForElementClickable(openCart,reportStatus);
